...
<div class="content registerform"> 
  ...
  <!-- BEGIN REGISTRATION FORM -->
    ...
    <p class="hint font-wht text-center"> Please enter your details below: </p>
    
    <form class="" action="index.html" method="post">
    <div class="row">
        
    
        <h4 class="font-wht text-center">Signup Details</h4>
    ...
    <div class="col-sm-6"><div class="form-group">
      ...
      <input class="form-control placeholder-no-fix" type="text" placeholder="Location (Company Site)" name="location" />
        ...
        <div class="row">
             ...
             <h4 class="font-wht text-center brdtop">Address Details</h4>
