...
<div class="content loginbox"> 
  ...
  <s:form id="login-form" class="login-form table" action="adminLogin" method="post">
    ...
    <div class="form-group">
        <s:textfield class="form-control form-control-solid placeholder-no-fix"  autocomplete="off" placeholder="Enter Full Name *" name="name" id="name" />
    </div>
    
     <div class="form-group">
        <s:textfield class="form-control form-control-solid placeholder-no-fix"  autocomplete="off" placeholder="Enter Business Email Address *" name="email" id="email" />
    </div>
    
    <div class="form-group">
        <s:textfield class="form-control form-control-solid placeholder-no-fix"  
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        <s:textarea cols="5" row="10" class="form-control-solid placeholder-no-fix mqery"  
                    autocomplete="off" placeholder="Enter Your Address" name="address" id="address" ></s:textarea>
    </div>
    
    
    <div class="form-group">
        <s:textarea cols="5" row="10" class="form-control-solid placeholder-no-fix mqery1"  
