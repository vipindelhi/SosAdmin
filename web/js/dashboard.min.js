/* global sample_data, App, Morris, Layout, moment, AmCharts */
            ...
            if (jQuery.plot) {
                ...
                if (0 != $("#site_statistics").size()) {
                    ...
                    $("#site_statistics").bind("plothover", function(t, i, l) {
                        $("#x").text(i.x.toFixed(2)), $("#y").text(i.y.toFixed(2)), l ? a != l.dataIndex && (a = l.dataIndex, $("#tooltip").remove(), l.datapoint[0].toFixed(2), l.datapoint[1].toFixed(2), e(l.pageX, l.pageY, l.datapoint[0], l.datapoint[1] + " visits")) : ($("#tooltip").remove(), a = null)
                    });
                }
                if (0 != $("#site_activities").size()) {
                    ...
                    $.plot($("#site_activities"), [{
                        ...
                        $("#x").text(a.x.toFixed(2)), $("#y").text(a.y.toFixed(2)), l && i != l.dataIndex && (i = l.dataIndex, $("#tooltip").remove(), l.datapoint[0].toFixed(2), l.datapoint[1].toFixed(2), e(l.pageX, l.pageY, l.datapoint[0], l.datapoint[1] + "M$"))
                ...
                o = function(a) {
                    ...
                    if (0 != l.length) {
                        var o = new Date,
                            ...
                            r = "";
                        r += '<li class="out">', r += '<img class="avatar" alt="" src="' + Layout.getLayoutImgPath() + 'avatar1.jpg"/>', r += '<div class="message">', r += '<span class="arrow"></span>', r += '<a href="#" class="name">Bob Nilson</a>&nbsp;', r += '<span class="datetime">at ' + n + "</span>", r += '<span class="body">', r += l, r += "</span>", r += "</div>", r += "</li>", t.append(r), i.val("");
                        var s = function() {
                            var t = 0;
    ...
    //---------Start-Emergency-chart----------- 
     ...
     //---------------start-chart-3--------------------   
        initAmChart3: function() {
            "undefined" != typeof AmCharts && 0 !== $("#dashboard_amchart_3").size() && AmCharts.makeChart("dashboard_amchart_3", {
                type: "serial",
                addClassNames: !0,
                theme: "light",
